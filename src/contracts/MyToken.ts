...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000000000000000000000'); // 500000000
        const decimals: u8 = 18; // 21
        const name: string = 'Test'; // mizusei
        const symbol: string = 'TEST'; // MZU
